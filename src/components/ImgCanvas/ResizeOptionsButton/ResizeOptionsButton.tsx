            ...
            >
              <MenuItem value={"nearestNeighbor"}>
                <Box display={"flex"} gap={0.5}>
                  Nearest neighbour
                  <Tooltip
                    title={`Nearest neighbor interpolation - to determine the tone value of a pixel in a scaled image, you need to find the closest pixel in the original image and set its tone level.`}
                  >
                    <InfoIcon />
                  </Tooltip>
                </Box>
              ...
              <MenuItem value={"bilinear"}>
                <Box display={"flex"} gap={0.5}>
                  Bilinear (soon)
                  <Tooltip
                    title={`Bilinear interpolation assigns the average value of four adjacent pixels of the original image to a pixel of the scaled image.`}
                  >
                    <InfoIcon />
                  </Tooltip>
                </Box>
